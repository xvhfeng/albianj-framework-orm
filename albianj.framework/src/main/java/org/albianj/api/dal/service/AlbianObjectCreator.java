...
public class AlbianObjectCreator {
    ...
    public static IAlbianObject newInstance(Object sessionId, String typeClzzName)  {
        AlbianObjectAttribute attr = AlbianEntityMetadata.getEntityMetadata(typeClzzName);
//        if (null == attr) {
...
//            }
    ...
    public static IAlbianObject newInstance(Object sessionId, Class<? extends IAlbianObject> typeClzz)  {
