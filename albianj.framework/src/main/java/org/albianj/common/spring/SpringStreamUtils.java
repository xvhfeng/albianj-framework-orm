 ...
 * @since 3.2.2
 */
public abstract class SpringStreamUtils {
	...
	public static String copyToString(ByteArrayOutputStream baos, Charset charset) {
		SpringAssert.notNull(baos, "No ByteArrayOutputStream specified");
		SpringAssert.notNull(charset, "No Charset specified");
	...
	public static void copy(byte[] in, OutputStream out) throws IOException {
		SpringAssert.notNull(in, "No input byte array specified");
		SpringAssert.notNull(out, "No OutputStream specified");
	...
	public static void copy(String in, Charset charset, OutputStream out) throws IOException {
		SpringAssert.notNull(in, "No input String specified");
		SpringAssert.notNull(charset, "No Charset specified");
		SpringAssert.notNull(out, "No OutputStream specified");
	...
	public static int copy(InputStream in, OutputStream out) throws IOException {
		SpringAssert.notNull(in, "No InputStream specified");
		SpringAssert.notNull(out, "No OutputStream specified");
	...
	public static long copyRange(InputStream in, OutputStream out, long start, long end) throws IOException {
		...
		byte[] buffer = new byte[(int) Math.min(SpringStreamUtils.BUFFER_SIZE, bytesToCopy)];
		while (bytesToCopy > 0) {
