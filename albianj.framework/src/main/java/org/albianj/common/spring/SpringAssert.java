 ...
 * @since 1.1.2
 */
public abstract class SpringAssert {
	 ...
	 * @see SpringStringUtils#hasLength
	 */
	public static void hasLength( String text, String message) {
		if (!SpringStringUtils.hasLength(text)) {
			throw new IllegalArgumentException(message);
		}
	}
	 ...
	 * @see SpringStringUtils#hasText
	 */
	public static void hasText( String text, String message) {
		if (!SpringStringUtils.hasText(text)) {
			throw new IllegalArgumentException(message);
		}
	}
	...
	public static void doesNotContain( String textToSearch, String substring, String message) {
		if (SpringStringUtils.hasLength(textToSearch) && SpringStringUtils.hasLength(substring) &&
	...
	private static void instanceCheckFailed(Class<?> type,  Object obj,  String msg) {
		...
		if (SpringStringUtils.hasLength(msg)) {
