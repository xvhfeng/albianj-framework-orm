...
public class AlbianOpenedStorageService extends FreeAlbianService implements IAlbianOpenedStorageService {
    ...
    @Override
    public IRunningStorageAttribute getStorage(String storageName){
        IAlbianStorageParserService asps = AlbianServiceHub.getSingletonService(IAlbianStorageParserService.class,IAlbianStorageParserService.Name);
    ...
    @Override
    public IRunningStorageAttribute getStorage(String storageName, String dbAliasName){
        IAlbianStorageParserService asps = AlbianServiceHub.getSingletonService(IAlbianStorageParserService.class,IAlbianStorageParserService.Name);
        IStorageAttribute sa = asps.getStorageAttribute(storageName);
    ...
    public Connection getConnection(String sessionId, String storageName, boolean isAutoCommit) {
        IAlbianStorageParserService asps = AlbianServiceHub.getSingletonService(IAlbianStorageParserService.class,IAlbianStorageParserService.Name);
        IRunningStorageAttribute rsa = getStorage(storageName);
