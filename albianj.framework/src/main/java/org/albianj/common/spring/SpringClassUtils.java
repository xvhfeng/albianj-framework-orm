...
public abstract class SpringClassUtils {
	 ...
	 */
	private static final Map<Method, Method> interfaceMethodCache = new SpringConcurrentReferenceHashMap<>(256);
	...
	public static Class<?> forName(String name,  ClassLoader classLoader)
		...
		SpringAssert.notNull(name, "Name must not be null");
	...
	public static boolean isCacheSafe(Class<?> clazz,  ClassLoader classLoader) {
		SpringAssert.notNull(clazz, "Class must not be null");
		try {
	 ...
	 * Also used by {@link SpringObjectUtils#nullSafeConciseToString}.
	...
	public static boolean isAssignable(Class<?> lhsType, Class<?> rhsType) {
		SpringAssert.notNull(lhsType, "Left-hand side type must not be null");
		SpringAssert.notNull(rhsType, "Right-hand side type must not be null");
	...
	public static boolean isAssignableValue(Class<?> type,  Object value) {
		SpringAssert.notNull(type, "Type must not be null");
	...
	public static String convertResourcePathToClassName(String resourcePath) {
		SpringAssert.notNull(resourcePath, "Resource path must not be null");
	...
	public static String convertClassNameToResourcePath(String className) {
		SpringAssert.notNull(className, "Class name must not be null");
	...
	public static String addResourcePathToPackagePath(Class<?> clazz, String resourceName) {
		SpringAssert.notNull(resourceName, "Resource name must not be null");
	...
	public static String classNamesToString( Collection<Class<?>> classes) {
		if (SpringCollectionUtils.isEmpty(classes)) {
			return "[]";
		}
	 ...
	 * @since 3.1
	 * @see SpringStringUtils#toStringArray
	 */
	public static Class<?>[] toClassArray( Collection<Class<?>> collection) {
		return (!SpringCollectionUtils.isEmpty(collection) ? collection.toArray(EMPTY_CLASS_ARRAY) : EMPTY_CLASS_ARRAY);
	}
	...
	public static Class<?>[] getAllInterfaces(Object instance) {
		SpringAssert.notNull(instance, "Instance must not be null");
	...
	public static Class<?> createCompositeInterface(Class<?>[] interfaces,  ClassLoader classLoader) {
		SpringAssert.notEmpty(interfaces, "Interface array must not be empty");
	...
	public static String getShortName(String className) {
		SpringAssert.hasLength(className, "Class name must not be empty");
	 ...
	 * @see SpringStringUtils#uncapitalizeAsProperty(String)
	 */
	public static String getShortNameAsProperty(Class<?> clazz) {
		String shortName = getShortName(clazz);
		int dotIndex = shortName.lastIndexOf(PACKAGE_SEPARATOR);
		shortName = (dotIndex != -1 ? shortName.substring(dotIndex + 1) : shortName);
		return SpringStringUtils.uncapitalizeAsProperty(shortName);
	}
	...
	public static String getPackageName(String fqClassName) {
		SpringAssert.notNull(fqClassName, "Class name must not be null");
	...
	public static String getQualifiedMethodName(Method method,  Class<?> clazz) {
		SpringAssert.notNull(method, "Method must not be null");
	...
	public static Method getMethod(Class<?> clazz, String methodName,  Class<?>... paramTypes) {
		SpringAssert.notNull(clazz, "Class must not be null");
		SpringAssert.notNull(methodName, "Method name must not be null");
		if (paramTypes != null) {
			try {
			...
			try {
				if (Modifier.isPublic(method.getModifiers())) {
					...
					Method specificMethod =
							SpringReflectionUtils.findMethod(targetClass, method.getName(), method.getParameterTypes());
