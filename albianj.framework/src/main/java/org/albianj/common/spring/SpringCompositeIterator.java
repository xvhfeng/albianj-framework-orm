 ...
 */
public class SpringCompositeIterator<E> implements Iterator<E> {
	...
	public void add(Iterator<E> iterator) {
		SpringAssert.state(!this.inUse, "You can no longer add iterators to a composite iterator that's already in use");
