...
/**
 * An {@link SpringIdGenerator} that uses {@link SecureRandom} for the initial seed and
 ...
 * @since 4.0
 */
public class SpringAlternativeJdkSpringIdGenerator implements SpringIdGenerator {

	private final Random random;


	public SpringAlternativeJdkSpringIdGenerator() {
