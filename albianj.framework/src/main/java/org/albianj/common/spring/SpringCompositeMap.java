 ...
 * {@link SpringCollectionUtils#compositeMap(Map, Map, BiFunction, Consumer)}.
 *
 ...
 */
final class SpringCompositeMap<K, V> implements Map<K, V> {
	...
	SpringCompositeMap(Map<K, V> first, Map<K, V> second) {
	...
	SpringCompositeMap(Map<K, V> first, Map<K, V> second,
		...
		SpringAssert.notNull(first, "First must not be null");
		SpringAssert.notNull(second, "Second must not be null");
		this.first = first;
		this.second = second;
	...
	@Override
	public Set<K> keySet() {
		return new SpringCompositeSet<>(this.first.keySet(), this.second.keySet());
	}

	@Override
	public Collection<V> values() {
		return new SpringCompositeCollection<>(this.first.values(), this.second.values());
	}

	@Override
	public Set<Entry<K, V>> entrySet() {
		return new SpringCompositeSet<>(this.first.entrySet(), this.second.entrySet());
	}
