 ...
 * @see org.springframework.beans.factory.config.BeanDefinitionVisitor#BeanDefinitionVisitor(SpringStringValueResolver)
 */
@FunctionalInterface
public interface SpringStringValueResolver {
