...
public class SpringPlaceholderResolutionException extends IllegalArgumentException {
	 ...
	 */
	SpringPlaceholderResolutionException(String reason, String placeholder, String value) {
		this(reason, placeholder, (value != null ? List.of(value) : Collections.emptyList()));
	}

	private SpringPlaceholderResolutionException(String reason, String placeholder, List<String> values) {
	...
	/**
	 * Return a {@link SpringPlaceholderResolutionException} that provides
	 * an additional parent value.
	 * @param value the parent value to add
	 * @return a new exception with the parent value added
	 */
	SpringPlaceholderResolutionException withValue(String value) {
		List<String> allValues = new ArrayList<>(this.values);
		allValues.add(value);
		return new SpringPlaceholderResolutionException(this.reason, this.placeholder, allValues);
	}
