...
public abstract class SpringReflectionUtils {
	 ...
	 */
	private static final Map<Class<?>, Method[]> declaredMethodsCache = new SpringConcurrentReferenceHashMap<>(256);

	/**
	 * Cache for {@link Class#getDeclaredFields()}, allowing for fast iteration.
	 */
	private static final Map<Class<?>, Field[]> declaredFieldsCache = new SpringConcurrentReferenceHashMap<>(256);
	...
	public static Method findMethod(Class<?> clazz, String name,  Class<?>... paramTypes) {
		...
		SpringAssert.notNull(name, "Method name must not be null");
	...
	public static Field findField(Class<?> clazz,  String name,  Class<?> type) {
		SpringAssert.notNull(clazz, "Class must not be null");
		SpringAssert.isTrue(name != null || type != null, "Either name or type of the field must be specified");
		Class<?> searchType = clazz;
	...
	public static void shallowCopyFieldState(final Object src, final Object dest) {
		SpringAssert.notNull(src, "Source for field copy cannot be null");
		SpringAssert.notNull(dest, "Destination for field copy cannot be null");
	...
	public interface MethodFilter {
		...
		default MethodFilter and(MethodFilter next) {
			SpringAssert.notNull(next, "Next MethodFilter must not be null");
	...
	public interface FieldFilter {
		...
		default FieldFilter and(FieldFilter next) {
			SpringAssert.notNull(next, "Next FieldFilter must not be null");
