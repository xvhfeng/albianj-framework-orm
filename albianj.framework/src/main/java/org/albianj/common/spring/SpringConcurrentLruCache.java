...
public final class SpringConcurrentLruCache<K, V> {
	 ...
	 */
	public SpringConcurrentLruCache(int capacity, Function<K, V> generator) {
		this(capacity, generator, 16);
	}

	private SpringConcurrentLruCache(int capacity, Function<K, V> generator, int concurrencyLevel) {
		SpringAssert.isTrue(capacity >= 0, "Capacity must be >= 0");
	...
	private void put(K key, V value) {
		SpringAssert.notNull(key, "key must not be null");
