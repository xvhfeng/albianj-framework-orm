 ...
 */
public abstract class SpringResourceUtils {
	...
	public static URL getURL(String resourceLocation) throws FileNotFoundException {
		SpringAssert.notNull(resourceLocation, "Resource location must not be null");
		if (resourceLocation.startsWith(CLASSPATH_URL_PREFIX)) {
			String path = resourceLocation.substring(CLASSPATH_URL_PREFIX.length());
			ClassLoader cl = SpringClassUtils.getDefaultClassLoader();
	...
	public static File getFile(URL resourceUrl, String description) throws FileNotFoundException {
		SpringAssert.notNull(resourceUrl, "Resource URL must not be null");
	...
	public static File getFile(URI resourceUri, String description) throws FileNotFoundException {
		SpringAssert.notNull(resourceUri, "Resource URI must not be null");
	...
	public static URL toURL(String location) throws MalformedURLException {
		try {
			...
			return toURI(SpringStringUtils.cleanPath(location)).toURL();
		}
	...
	public static URL toRelativeURL(URL root, String relativePath) throws MalformedURLException {
		...
		relativePath = SpringStringUtils.replace(relativePath, "#", "%23");

		return toURL(SpringStringUtils.applyRelativePath(root.toString(), relativePath));
	}
