...
public class SpringPropertyPlaceholderHelper {
	...
	private final SpringPlaceholderParser parser;
	 ...
	 */
	public SpringPropertyPlaceholderHelper(String placeholderPrefix, String placeholderSuffix) {
	 ...
	 * {@link SpringPropertyPlaceholderHelper#SpringPropertyPlaceholderHelper(String, String, String, Character, boolean)}
	 */
	...
	public SpringPropertyPlaceholderHelper(String placeholderPrefix, String placeholderSuffix,
		...
		SpringAssert.notNull(placeholderPrefix, "'placeholderPrefix' must not be null");
		SpringAssert.notNull(placeholderSuffix, "'placeholderSuffix' must not be null");
		this.parser = new SpringPlaceholderParser(placeholderPrefix, placeholderSuffix,
	...
	public String replacePlaceholders(String value, final Properties properties) {
		SpringAssert.notNull(properties, "'properties' must not be null");
