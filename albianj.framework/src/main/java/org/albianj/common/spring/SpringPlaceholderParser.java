 ...
 * @since 6.2
 */
final class SpringPlaceholderParser {
...
//	private static final Log logger = LogFactory.getLog(PlaceholderParser.class);
	 ...
	 */
	SpringPlaceholderParser(String prefix, String suffix, String separator,
	 ...
	 */
	public String replacePlaceholders(String value, SpringPropertyPlaceholderHelper.PlaceholderResolver placeholderResolver) {
		SpringAssert.notNull(value, "'value' must not be null");
	...
	private int nextValidEndPrefix(String value, int startIndex) {
		...
		while (index < value.length()) {
			if (SpringStringUtils.substringMatch(value, index, this.suffix)) {
			...
			else if (SpringStringUtils.substringMatch(value, index, this.simplePrefix)) {
				withinNestedPlaceholder++;
	 ...
	 */
	static class PartResolutionContext implements SpringPropertyPlaceholderHelper.PlaceholderResolver {
		...
		private final SpringPropertyPlaceholderHelper.PlaceholderResolver resolver;

		
		private Set<String> visitedPlaceholders;


		PartResolutionContext(SpringPropertyPlaceholderHelper.PlaceholderResolver resolver, String prefix, String suffix,
...
//			}
		...
		public String handleUnresolvablePlaceholder(String key, String text) {
			...
			throw new SpringPlaceholderResolutionException(
		...
		public void removePlaceholder(String placeholder) {
			SpringAssert.state(this.visitedPlaceholders != null, "Visited placeholders must not be null");
	...
	record ParsedValue(String text, List<Part> parts) {
		...
		public String resolve(PartResolutionContext resolutionContext) {
			...
			catch (SpringPlaceholderResolutionException ex) {
	 ...
	 */
	record SimplePlaceholderPart(String text, String key,  String fallback) implements Part {
	 ...
	 */
	record NestedPlaceholderPart(String text, List<Part> keyParts,  List<Part> defaultParts) implements Part {
