...
public class AblCrt {
    ...
    public static IAblObj newInst(Object sessionId, String typeClzzName)  {
...
//            }
    ...
    public static IAblObj newInst(Object sessionId, Class<? extends IAblObj> typeClzz)  {
        return newInst(sessionId, typeClzz.getName());
    }
}
