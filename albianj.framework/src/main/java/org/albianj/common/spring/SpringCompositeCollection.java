 ...
 * exposed through {@link SpringCompositeMap#values()}.
 *
 * @author Arjen Poutsma
 * @since 6.2
 * @param <E> the type of elements maintained by this collection
 */
class SpringCompositeCollection<E> implements Collection<E> {
	...
	SpringCompositeCollection(Collection<E> first, Collection<E> second) {
	...
	public Iterator<E> iterator() {
		SpringCompositeIterator<E> iterator = new SpringCompositeIterator<>();
