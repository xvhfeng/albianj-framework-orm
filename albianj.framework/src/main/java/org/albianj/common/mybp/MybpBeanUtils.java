 ...
 * @since 2018-06-12
 */
public final class MybpBeanUtils {

    private MybpBeanUtils() {
    }
    ...
    public static <T> T mapToBean(Map<String, ?> map, Class<T> clazz) {
        T bean = MybpClassUtils.newInstance(clazz);
    ...
    public static <T> List<Map<String, Object>> beansToMaps(List<T> beans) {
        ...
        return beans.stream().map(MybpBeanUtils::beanToMap).collect(toList());
    }
