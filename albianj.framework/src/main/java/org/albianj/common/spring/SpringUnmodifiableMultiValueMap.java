...
/**
 * Unmodifiable wrapper for {@link SpringMultiValueMap}.
 *
 ...
 */
final class SpringUnmodifiableMultiValueMap<K,V> implements SpringMultiValueMap<K,V>, Serializable {

	private static final long serialVersionUID = -8697084563854098920L;

	private final SpringMultiValueMap<K, V> delegate;
	...
	public SpringUnmodifiableMultiValueMap(SpringMultiValueMap<? extends K, ? extends V> delegate) {
		SpringAssert.notNull(delegate, "Delegate must not be null");
		this.delegate = (SpringMultiValueMap<K, V>) delegate;
	}
	...
	@Override
	public void addAll(SpringMultiValueMap<K, V> values) {
		throw new UnsupportedOperationException();
	}
