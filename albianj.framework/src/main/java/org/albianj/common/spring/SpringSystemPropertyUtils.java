 ...
 */
public abstract class SpringSystemPropertyUtils {
	...
	private static final SpringPropertyPlaceholderHelper strictHelper =
			new SpringPropertyPlaceholderHelper(PLACEHOLDER_PREFIX, PLACEHOLDER_SUFFIX, VALUE_SEPARATOR,
					ESCAPE_CHARACTER, false);

	private static final SpringPropertyPlaceholderHelper nonStrictHelper =
			new SpringPropertyPlaceholderHelper(PLACEHOLDER_PREFIX, PLACEHOLDER_SUFFIX, VALUE_SEPARATOR,
	...
	public static String resolvePlaceholders(String text, boolean ignoreUnresolvablePlaceholders) {
		...
		SpringPropertyPlaceholderHelper helper = (ignoreUnresolvablePlaceholders ? nonStrictHelper : strictHelper);
	 ...
	 */
	private static class SystemPropertyPlaceholderResolver implements SpringPropertyPlaceholderHelper.PlaceholderResolver {
