 ...
 * @author Sam Brannen
 * @since 19.03.2004
 * @see SpringClassUtils
 * @see SpringCollectionUtils
 * @see SpringStringUtils
 */
public abstract class SpringObjectUtils {
	 ...
	 * @see SpringObjectUtils#isEmpty(Object[])
	 * @see SpringStringUtils#hasLength(CharSequence)
	 * @see SpringCollectionUtils#isEmpty(Collection)
	 * @see SpringCollectionUtils#isEmpty(Map)
	 */
	...
	public static Object unwrapOptional( Object obj) {
		if (obj instanceof Optional<?> optional) {
			...
			SpringAssert.isTrue(!(result instanceof Optional), "Multi-level Optional usage not supported");
			return result;
		}
		return obj;
	}
	 ...
	 * <li>Potentially {@linkplain SpringStringUtils#truncate(CharSequence) truncated string}
	 ...
	 * @since 5.3.27
	 * @see #nullSafeToString(Object)
	 * @see SpringStringUtils#truncate(CharSequence)
	 * @see SpringClassUtils#isSimpleValueType(Class)
	 */
	public static String nullSafeConciseToString( Object obj) {
		...
		if (obj instanceof CharSequence charSequence) {
			return SpringStringUtils.truncate(charSequence);
		}
		Class<?> type = obj.getClass();
		if (SpringClassUtils.isSimpleValueType(type)) {
			String str = obj.toString();
			if (str != null) {
				return SpringStringUtils.truncate(str);
			}
		}
