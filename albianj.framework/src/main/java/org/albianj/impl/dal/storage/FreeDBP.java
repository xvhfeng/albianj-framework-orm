...
public abstract class FreeDataBasePool implements IDataBasePool {
    ...
    protected DataSource getDatasource(String sessionid,final String key, RStgAttr rsa)  {
        ...
        synchronized (_dataSource) {
            ...
            if (ds == null) {
                ServRouter.log(ServRouter.__StartupSessionId,  LogLevel.Info,
                        "create datasource storage::{} ,database::{}", rsa.getStgAttr().getName(),
                    rsa.getDatabase());
                try {
    ...
    protected abstract DataSource setupDataSource(String sessionid,final String key, final RStgAttr rsa) ;
