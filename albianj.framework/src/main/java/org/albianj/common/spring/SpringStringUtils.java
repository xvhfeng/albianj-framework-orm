...
//	}
	...
	public static String[] toStringArray( Collection<String> collection) {
		return (SetUtil.isNotEmpty(collection) ? collection.toArray(EMPTY_STRING_ARRAY) : EMPTY_STRING_ARRAY);
	}
	...
	public static String[] concatenateStringArrays( String[] array1,  String[] array2) {
		if (SetUtil.isEmpty(array1)) {
			return array2;
		}
		if (SetUtil.isEmpty(array2)) {
			return array1;
		}
	...
	public static String truncate(CharSequence charSequence, int threshold) {
		SpringAssert.isTrue(threshold > 0,
