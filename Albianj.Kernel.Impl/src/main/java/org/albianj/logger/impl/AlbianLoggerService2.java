...
public class AlbianLoggerService2 extends FreeAlbianService implements IAlbianLoggerService2 {
    ...
    @Override
    public void log(String filename, String methodName, int lineNumber, String loggerName, Object sessionId,
        AlbianLoggerLevel level, String format, Object... values) {
    ...
    @Override
    @Deprecated
    public void logAndThrow(String filename, String methodName, int lineNumber, String loggerName, Object sessionId,
        AlbianLoggerLevel level, Throwable e, AlbianModuleType module, String throwInfo, String format,
        Object... values) throws AlbianRuntimeException {
        Logger logger = getLogger(loggerName);
        String msg = null;
        if (null != logger) {
    ...
    @Override
    public void log(String loggerName, Object sessionId, AlbianLoggerLevel level, Throwable e, String format,
        Object... values) {
    ...
    @Deprecated
    @Override
    public void logAndThrow(String loggerName, Object sessionId, AlbianLoggerLevel level, Throwable e,
    ...
    private String makeLogInfo(String filename, String methodName, int lineNumber, Object sessionId,
        AlbianLoggerLevel level, Throwable e, String format, Object... values) {
        ...
        sb.append("File:").append(filename).append(",").append("Line:").append(lineNumber).append(",").append("Method:")
    ...
    private String flush(String filename, String methodName, int lineNumber, Logger logger, Object sessionId,
        AlbianLoggerLevel level, Throwable e, String format, Object... values) {
        switch (level) {
            case Debug:
