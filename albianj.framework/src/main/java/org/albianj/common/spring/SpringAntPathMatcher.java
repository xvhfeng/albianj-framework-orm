...
/**
 * {@link SpringPathMatcher} implementation for Ant-style path patterns.
 *
 ...
 * @since 16.07.2003
 */
public class SpringAntPathMatcher implements SpringPathMatcher {
	 ...
	 * @since 4.1
	 */
	public SpringAntPathMatcher(String pathSeparator) {
		SpringAssert.notNull(pathSeparator, "'pathSeparator' must not be null");
