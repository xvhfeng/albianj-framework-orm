...
/**
 * {@code RouteMatcher} that delegates to a {@link SpringPathMatcher}.
 *
 ...
 * @since 5.2
 */
public class SpringSimpleRouteMatcher implements SpringRouteMatcher {

	private final SpringPathMatcher pathMatcher;


	/**
	 * Create a new {@code SimpleRouteMatcher} for the given
	 * {@link SpringPathMatcher} delegate.
	 */
	public SpringSimpleRouteMatcher(SpringPathMatcher pathMatcher) {
		SpringAssert.notNull(pathMatcher, "PathMatcher is required");
		this.pathMatcher = pathMatcher;
	}

	/**
	 * Return the underlying {@link SpringPathMatcher} delegate.
	 */
	public SpringPathMatcher getPathMatcher() {
